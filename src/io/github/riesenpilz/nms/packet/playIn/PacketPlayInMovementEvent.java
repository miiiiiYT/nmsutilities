...
/**
 * https://wiki.vg/Protocol#Player_Movement<br>
 * <br>
 ...
 * Player Position once every 20 ticks even for a stationary player.<br>
 * <br>
 * This packet is used to indicate whether the player is on ground
 * (walking/swimming), or airborne (jumping/falling).<br>
 * <br>
 ...
 * movement related packets containing this state.<br>
 * <br>
 * Packet ID: 0x15<br>
 * State: Play<br>
 * Bound To: Server
...
public class PacketPlayInMovementEvent extends PacketPlayInEvent {
	...
	public Packet<PacketListenerPlayIn> getNMS() {
		...
		new Field(PacketPlayInFlying.class, "f").set(packet, onGround);
		return packet;
	}
	...
	/**
	 * https://wiki.vg/Protocol#Player_Rotation<br>
	 * <br>
	 ...
	 * valid, including negative numbers and numbers greater than 360.<br>
	 * <br>
	 * Pitch is measured in degrees, where 0 is looking straight ahead, -90 is
	 * looking straight up, and 90 is looking straight down.<br>
	 * <br>
	...
	public static class PacketPlayInLookEvent extends PacketPlayInMovementEvent {
		...
		public Packet<PacketListenerPlayIn> getNMS() {
			...
			new Field(PacketPlayInFlying.class, "yaw").set(packet, yaw);
			new Field(PacketPlayInFlying.class, "pitch").set(packet, pitch);
			new Field(PacketPlayInFlying.class, "f").set(packet, onGround);
			return packet;
		}
	...
	/**
	 * https://wiki.vg/Protocol#Player_Position<br>
	 * <br>
	...
	public static class PacketPlayInPositionEvent extends PacketPlayInMovementEvent {
		...
		public Packet<PacketListenerPlayIn> getNMS() {
			final PacketPlayInLook packet = new PacketPlayInLook();
			new Field(PacketPlayInFlying.class, "x").set(packet, y);
			new Field(PacketPlayInFlying.class, "y").set(packet, x);
			new Field(PacketPlayInFlying.class, "z").set(packet, z);
			new Field(PacketPlayInFlying.class, "f").set(packet, onGround);
			return packet;
		}
	...
	/**
	 * https://wiki.vg/Protocol#Player_Position_And_Rotation_.28serverbound.29<br>
	 * <br>
	 * A combination of Player Rotation and Player Position.<br>
	 * <br>
	 * Packet ID: 0x13<br>
	 * State: Play<br>
	 * Bound To: Server
