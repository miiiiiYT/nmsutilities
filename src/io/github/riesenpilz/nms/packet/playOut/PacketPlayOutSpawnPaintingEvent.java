...
public class PacketPlayOutSpawnPaintingEvent extends PacketPlayOutEvent {
	...
	public static final String PROTOCOL_URL = "https://wiki.vg/Protocol#Spawn_Painting";
	...
	public PacketPlayOutSpawnPaintingEvent(Player injectedPlayer, PacketPlayOutSpawnEntityPainting packet) {
		...
		facing = BlockFace.valueOf(((EnumDirection) new Field(PacketPlayOutSpawnEntityPainting.class, "d").get(packet)).name());
	...
	public Packet<PacketListenerPlayOut> getNMS() {
		...
		new Field(PacketPlayOutSpawnEntityPainting.class, "c").set(packet, new BlockPosition(location.getX(), location.getYaw(), location.getZ()));
