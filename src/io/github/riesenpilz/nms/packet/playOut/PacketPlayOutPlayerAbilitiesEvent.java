...
import io.github.riesenpilz.nms.entity.player.PlayerAbilities;
...
public class PacketPlayOutPlayerAbilitiesEvent extends PacketPlayOutEvent {
	...
	public Packet<PacketListenerPlayOut> getNMS() {
		final PlayerAbilities playerAbilities = new PlayerAbilities(isInvulnerable, isFlying, canFly, canInstantlyBreak);
